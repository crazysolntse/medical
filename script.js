    ...
    const res = await fetch("https://openrouter.ai/api/v1/chat/completions ", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: "Ты знаток ресторанов и кофеен в Москве. Посоветуй топовое место, где поесть. Сначала название, потом вставь разрыв строки далее предложение, которое описывает преимущество и особенности места. вставь разрыв строки , Далее ценовая категория (₽,₽₽,₽₽₽). Номер телефона. Далее гео (метро и название улицы). Далее ссылка на сайт. "
          },
          {
            role: "user",
            content: question

    ...
    const res = await fetch("https://openrouter.ai/api/v1/chat/completions ", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: "Ты знаток ресторанов в Москве. Посоветуй 3 топовых места по запросу. Учти гео из запроса, Не выдумывай места, покажи реальные. Сначала покажи название, в одной фразе опиши особенности места. Далее ценовая категория (₽,₽₽,₽₽₽). Далее Номер телефона. Далее гео (метро и название улицы). Гео и телефон не выдумывай скажи настоящие. Раздели все пункты жирной точкой и \n  "
          },
          {
            role: "user",
            content: question
